...
**Формат:** `stg_bronze__<тип>_<название_объекта>__<header|goods>`
...
**Формат:** `int_07_02_<название_документа>_prepared`
...
### 5. Финальная витрина (Этап 5)

**Формат:** `mart_07_02_all_errors`

## Сводная таблица

| Слой              | Префикс              | Пример имени модели                          | Материализация |
|-------------------|----------------------|----------------------------------------------|----------------|
| Staging           | `stg_bronze__`       | `stg_bronze__doc_check_kkm_header.sql`       | view           |
| Prepare           | `int_07_02_`         | `int_07_02_check_kkm_prepared.sql`            | table          |
| Enriched          | `int_07_02_`         | `int_07_02_check_kkm_enriched.sql`            | view           |
| Errors            | `mart_07_02_`        | `mart_07_02_check_kkm_errors.sql`             | table          |
| All Errors        | `mart_07_02_all_errors` | `mart_07_02_all_errors.sql`               | view           |
...
- Не используем коды подпроектов (`_yy_`) в именах моделей.
